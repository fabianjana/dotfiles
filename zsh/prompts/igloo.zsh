...
prompt_igloo_setup() {
  ...
  if test -z "$VIRTUAL_ENV" ; then
      ...
      seg_venv="${nord3}[${nord9}`basename \"$VIRTUAL_ENV\"`${nord3}]${c_reset} "
  fi

  PROMPT="${seg_connect_bar_down}${seg_user_host}${seg_jobs}${seg_exit_status}${seg_time}${seg_working_dir}${seg_git}${seg_arrow}${seg_venv}"
}
